      ...
      <div className="page">
            ...
            <div className="card-header">
              ...
              {previewImage && (
                <button
                  className="small-btn"
                  onClick={() =>
                    downloadImage(previewImage, "uploaded-image.jpg")
                  }
                >
                  Download
                </button>
        ...
        <section className="results-grid">
          ...
          <div className="result-card detected-card">
            <div className="section-title detected-title">
              <div>
                <h2>Detected Objects</h2>
                <p>Confidence score for each detected object</p>
              </div>

              <span className="detected-pill">{objects.length} Found</span>
            </div>
                ...
                objects.map((obj, index) => (
                  <div className="object-card" key={index}>
                    <div className="object-left">
                      <div className="object-number">{index + 1}</div>
